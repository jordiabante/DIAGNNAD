# -*- coding: utf-8 -*-
"""lightGBM_madeup_data_interactions.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18UBL-uKYjCU17hznJi0TOei0TKvvG48l
"""
...
# creem el model d'arbres per classificar
    # Define the parameters for the grid search
        parameters = {
            ...
            'max_depth': [1, 5, 10]  # Test different values for max_depth
            }
...
print(str(round(np.mean(balanced_accuracy),4)) + ' +- ' + str(round(np.std(balanced_accuracy),4)))
...
file_1 = open('./res_lightGBM_madeup_data_int.json','w')
