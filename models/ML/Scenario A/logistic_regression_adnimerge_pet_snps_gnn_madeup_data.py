# -*- coding: utf-8 -*-
"""logistic_regression_adnimerge_PET_snps_GNN_madeup_data.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EXu-tCTugsBvGbwKWVbij3gwW04aLf3a
"""
...
# model = LogisticRegression(penalty='l1', solver='liblinear', max_iter=1000)
    ...
    # Make the prediction
        ...
        # I look for the top5 as the fisrt one here is always the AGE!!
...
print(str(round(np.mean(roc_auc_list[1]),4)) + ' +- ' + str(round(np.std(roc_auc_list[1]),4)))
...
file_1 = open('./res_logreg_madeup_data_l2.json','w')
