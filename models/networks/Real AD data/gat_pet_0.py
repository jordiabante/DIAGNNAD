...
Original file is located at
    https://colab.research.google.com/drive/1bo7pUslRrxKo40CRI-OfL4oEnThJ85iW
"""
...
from gnn_definitions import train, validation, test, GAT
os.chdir('/biofisica/home/creatio_student/project_gnn_ad/models/GAT_grid_0')

with open('/biofisica/home/creatio_student/project_gnn_ad/file_articolo/training_0_GNN_PET.pickle', 'rb') as handle:
    training_list = pickle.load(handle)

with open('/biofisica/home/creatio_student/project_gnn_ad/file_articolo/validation_0_GNN_PET.pickle', 'rb') as handle:
...
file_1 = open('./risultati_GAT_PET_0.json','w')
json.dump(result,file_1)
file_1.close()

with open('/biofisica/home/creatio_student/project_gnn_ad/models/GAT_grid_0/embeddings_post_GNN', 'wb') as file:
    pickle.dump(x_toplot_post_GNN, file)
with open('/biofisica/home/creatio_student/project_gnn_ad/models/GAT_grid_0/embeddings_post_lin', 'wb') as file:
...
##GAT dimensions:
#input torch.Size([3776, 15])
#after first layer GCN torch.Size([3776, 8])
#after pooling torch.Size([3024, 8])
#after second pooling torch.Size([16, 8])
#age torch.Size([16])
#gender torch.Size([16])
#with gender and age torch.Size([16, 10])
#after first linear torch.Size([16, 10])
#after second linear torch.Size([16])
##GCN
#input torch.Size([3776, 15])
#after first layer GCN torch.Size([3776, 8])
#after pooling torch.Size([3024, 8])
...
#create a matrics and compute the embedding devo unirli come una matrice e poi ora che ho la matrice runno in umap o un TSNE V
    # usa quella roba che ha mandato jordi (ci sto lavorando)
    #fai anche una grid serch per cercare di ottimizzare V
    #vedi anche un plot per separare nel tempo i 0 e i 1 andando avanti nelle epoche tipo quello che faceva in karatenetwork V